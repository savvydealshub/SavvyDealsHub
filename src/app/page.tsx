    ...
    <div className="space-y-12">
      <section className="text-center space-y-4 pt-10">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 px-4 py-3 rounded-full bg-sdh-surface shadow-soft border border-slate-200/70 dark:bg-sdh-surface-dark dark:border-slate-800">
