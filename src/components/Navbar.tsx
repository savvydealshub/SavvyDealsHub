        ...
        <div className="relative">
          ...
          {menuOpen && (
            <div className="absolute left-1/2 -translate-x-1/2 mt-3 w-52 rounded-2xl bg-sdh-surface shadow-soft border border-slate-200/80 dark:bg-sdh-surface-dark dark:border-slate-700/80 overflow-hidden">
              <nav className="py-1">
                <Link href="/login" className="block px-4 py-2 text-sm hover:bg-sdh-bg dark:hover:bg-sdh-bg-dark/70">
                  Login
                </Link>
                ...
                <Link href="/contact" className="block px-4 py-2 text-sm hover:bg-sdh-bg dark:hover:bg-sdh-bg-dark/70">
                  Contact
                </Link>
                <Link href="/help" className="block px-4 py-2 text-sm hover:bg-sdh-bg dark:hover:bg-sdh-bg-dark/70">
                  Help &amp; FAQ
                </Link>
              </nav>
            </div>
