              ...
              >
                <td className="p-3">
                  <div className="relative h-14 w-14 overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800">
                    {o.imageUrl ? (
                      <Image src={o.imageUrl} alt={o.title} fill sizes="56px" className="object-cover" />
                    ) : null}
                  </div>
                </td>
                <td className="p-3">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    <a
                      href={
                        o.offerId
                          ? `/out?offerId=${encodeURIComponent(String(o.offerId))}&src=compare&cta=${encodeURIComponent(
